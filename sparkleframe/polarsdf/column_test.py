...
class TestUnsupportedComplexComparisons:
    ...
    These are polars-engine internals (they assert sparkleframe's own error message and
    build frames from native polars List/Struct/Map layouts), not Spark-parity cases, so
    they stay co-located here rather than in the shared parity suite.
    """
